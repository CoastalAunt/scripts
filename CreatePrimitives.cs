...
public class CreatePrimitives : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject.CreatePrimitive(PrimitiveType.Cube).transform.position =new Vector3(-0.5, 1, 0);
        GameObject.CreatePrimitive(PrimitiveType.Cube).transform.position =new Vector3(0.5, 1, 0);
        GameObject.CreatePrimitive(PrimitiveType.Cube).transform.position =new Vector3(-0.5, 2, 0);
